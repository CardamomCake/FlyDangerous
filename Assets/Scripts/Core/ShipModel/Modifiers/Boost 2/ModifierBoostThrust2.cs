...
namespace Core.ShipModel.Modifiers.Boost2 {
    ...
    public class ModifierBoost2Thrust : MonoBehaviour, IModifier {
        ...
        private AudioSource _boost2Sound;
        ...
        public void Awake() {
            _boost2Sound = GetComponent<AudioSource>();
        }
        ...
        public void ApplyModifierEffect(Rigidbody shipRigidBody, ref AppliedEffects effects) {
            ...
            if (!_boost2Sound.isPlaying) _boost2Sound.Play();
            ...
            // when using old boost2 moddel, force is applied every tick
        ...
        public void ApplyInitialEffect(Rigidbody shipRigidBody, ref AppliedEffects effects) {
            var parameters = shipRigidBody.gameObject.GetComponent<ShipPlayer>().ShipPhysics.FlightParameters;
            // when using balistic boost2 bodel force is applied once
